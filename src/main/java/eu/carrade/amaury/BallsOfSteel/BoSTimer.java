...
public class BoSTimer
{
    ...
    /**
     * Pauses (or restarts after a pause) the timer. <p> If the timer is not
    ...
    /**
     * Returns the display name of the timer. <p> The display name is the name
     * with all &-based color codes replaced by §-based ones.
     *
     * @return The name.
     */
    ...
    /**
     * Returns the number of hours left until the end of this countdown, before
     * the last update. <p> Used by the scoreboard, to remove the old score.
     *
     * @return The old number of hours left, or -1 if the timer was never
     * updated.
     */
    ...
    /**
     * Returns the number of minutes left until the end of this countdown,
     * before the last update. <p> Used by the scoreboard, to remove the old
     * score.
     *
     * @return The old number of minutes left, or -1 if the timer was never
     * updated.
     */
     ...
     * score.
     *
     * @return The old number of seconds left, or -1 if the timer was never
     * updated.
     */
