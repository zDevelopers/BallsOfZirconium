...
import eu.carrade.amaury.ballsofzirconium.utils.BoSSound;
...
public class GameConfig extends Configuration
{
    ...
    static public final ConfigurationItem<String> GAME_NAME = item("gameName", "Balls of Zirconium");
    ...
    static public class BarSection extends ConfigurationSection
    {
        ...
        public final ConfigurationItem<String> TITLE = item("title", "Balls of Zirconium");
